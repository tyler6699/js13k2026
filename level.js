...
var Level = {
  levels: [
    ...
    },
    {
      ...
      platformSpeed: 70,
      platformAxis: "x",
      // Red is still forgiving; orange introduces a single moving-platform gap.
      rows: makeLevelRows(58, 13, [
        [4, 52, "D"],
        [6, 31, "O"],
        [6, 49, "111111111"],
        [7, 23, "rrrrrrrrrrrrrr"],
        ...
        [9, 12, "C"],
        [10, 9, "1111111"],
        [11, 0, "1111111111111111111^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^111111111"],
      ]),
    },
    {
    ...
    },
    {
      ...
      platformSpeed: 105,
      platformAxis: "x",
      // A sustained wall-jump shaft leads into the first collapsing indigo sprint.
      rows: makeLevelRows(79, 20, [
        [5, 63, "I"],
        [5, 75, "D"],
        [7, 53, ">"],
        [7, 59, "1    1iiiiiiiii11111"],
        [7, 74, "1111"],
        [8, 52, "B"],
        [8, 59, "1    1"],
        [9, 49, "1111111"],
